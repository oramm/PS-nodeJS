...
var InvoicesController = /** @class */ (function () {
    ...
    InvoicesController.getInvoicesList = function (initParamObject, cb) {
    ...
    InvoicesController.processInvoicesResult = function (result) {
        var newResult = [];
        for (var _i = 0, result_1 = result; _i < result_1.length; _i++) {
            var row = result_1[_i];
            var item = new Invoice_1.default({
                id: row.Id,
                number: row.Number,
                ...
                _entity: {
                    id: row.EntityId,
                    name: ToolsDb_1.default.sqlToString(row.EntityName),
                ...
                _contract: {
                    ...
                    name: ToolsDb_1.default.sqlToString(row.ContractName),
