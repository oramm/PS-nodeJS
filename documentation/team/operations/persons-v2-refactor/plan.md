...
1. Read this file: `documentation/team/operations/persons-v2-refactor/plan.md`.
2. Read current status: `documentation/team/operations/persons-v2-refactor/progress.md`.
...
- update `documentation/team/operations/post-change-checklist.md`
...
6. LLM MUST automatically update `documentation/team/operations/persons-v2-refactor/progress.md` after every completed session and after every closed phase checkpoint.
