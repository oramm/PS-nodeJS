...
/**
 * Repository dla MilestoneDate - warstwa dostępu do danych
 *
 * Zgodnie z Clean Architecture:
 * - Dziedziczy po BaseRepository<MilestoneDate>
 * - Odpowiedzialny TYLKO za operacje CRUD i SQL
 * - NIE zawiera logiki biznesowej
 */
export default class MilestoneDateRepository extends BaseRepository<MilestoneDate> {
    constructor() {
        super('MilestoneDates');
    }

    /**
     * Mapuje wiersz z bazy danych na obiekt MilestoneDate
     * NIE używane bezpośrednio - find() ma własne mapowanie z JOIN
     */
    protected mapRowToModel(row: any): MilestoneDate {
        return new MilestoneDate({
            id: row.Id,
    ...
    /**
     * Wyszukuje MilestoneDates w bazie danych
     *
    ...
    /**
     * Tworzy warunki AND dla wyszukiwania
     */
    private makeAndConditions(
        searchParams: MilestoneDatesSearchParams
    ): string {
    ...
    /**
     * Przetwarza wyniki z bazy danych i mapuje na MilestoneDate
     */
    private processMilestoneDatesResult(result: any[]): MilestoneDate[] {
        const newResult: MilestoneDate[] = [];
    ...
    /**
     * Tworzy obiekt Contract z wiersza bazy danych
     */
    ...
    /**
     * Tworzy obiekt Offer z wiersza bazy danych
     */
