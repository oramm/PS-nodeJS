...
export default class ToolsGapi {
     ...
     */
    static async authorize(credentials: any, callback: any) {
        ...
        fs.readFile(this.TOKEN_PATH, async (err, token: any) => {
            if (err)
     ...
     */
    private static getAccessToken(oAuth2Client: any, callback: Function) {
